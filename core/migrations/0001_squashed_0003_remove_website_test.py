# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-12-02 19:03
...
class Migration(migrations.Migration):
    ...
    replaces = [('core', '0001_initial'), ('core', '0002_website_test'), ('core', '0003_remove_website_test')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('css_id', models.CharField(blank=True, max_length=128, verbose_name='CDD unique id')),
                ('css_inline', models.CharField(blank=True, max_length=1200, verbose_name='CSS en ligne')),
                ('nom', models.CharField(blank=True, max_length=512)),
                ...
                ('blocks', models.ManyToManyField(related_name='section', to='core.Block')),
